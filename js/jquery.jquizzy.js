...
(function ($) {
    ...
    $.fn.jquizzy = function (settings) {
        ...
        var defaults = {
            ...
            startText: 'Mulai Kuis !',
            endText: 'Selesai !',
            splashImage: 'img/start.png',
            twitterImage: 'img/share.png',
            resultComments: {
                perfect: 'Ini saatnya saya bilang Sempurna',
                excellent: 'Excellent!',
                good: 'Good!',
                average: 'Acceptable!',
                bad: 'Disappointing!',
        ...
        var superContainer = $(this),
            ...
            exitFob = '<div class="results-container slide-container"><div class="question-number">' + config.endText + '</div><div class="result-keeper"></div></div><div class="notice">Pilih Jawaban!</div><div class="progress-keeper" ><div class="progress"></div></div>',
            contentFob = '';
        ...
        for (questionsIteratorIndex = 0; questionsIteratorIndex < config.questions.length; questionsIteratorIndex++) {
            ...
            if (questionsIteratorIndex !== 0) {
                contentFob += '<div class="prev" style="left:55px;top:370px;"><a class="nav-previous" href="#">Prev</a></div>';
            }

            if (questionsIteratorIndex < config.questions.length - 1) {
                contentFob += '<div class="next" style="left:460px;top:370px;";><a class="nav-next" href="#">Next</a></div>';
            } else {
               contentFob += '<div class="next final" style="left:460px;top:370px;"><a class="nav-show-result" href="#">Finish</a></div>';
            }
        ...
        superContainer.find('.final').click(function () {
            ...
            for (var i = 0, toLoopTill = results.length; i < toLoopTill; i++) {
                ...
                resultSet += '<div class="result-row"> Question #' + (i + 1) + (results[i] === true ? "<div class='correct'><span>Benar</span></div>" : "<div class='wrong'><span>Salah</span></div>");
            ...
            resultSet = '<h2 class="qTitle">' + judgeSkills(score) + '<font color="blue"> Nilaimu ' + score + '</font></h2>' + shareButton + resultSet + '<div class="jquizzy-clear"></div>';
