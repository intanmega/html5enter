    ...
    $.fn.jquizzy = function (settings) {
        ...
        for (questionsIteratorIndex = 0; questionsIteratorIndex < config.questions.length; questionsIteratorIndex++) {
            ...
            if (questionsIteratorIndex !== 0) {
                contentFob += '<div class="prev" style="left:55px;top:280px;"><a class="nav-previous" href="#">Prev</a></div>';
            }

            if (questionsIteratorIndex < config.questions.length - 1) {
                contentFob += '<div class="next" style="left:460px;top:280px;";><a class="nav-next" href="#">Next</a></div>';
            } else {
                contentFob += '<div class="next final" style="left:460px;top:280px;"><a class="nav-show-result" href="#">Finish</a></div>';
            }
